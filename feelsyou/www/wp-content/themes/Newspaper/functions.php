...
/** 
* Custom widget area added for top post ad
*/

register_sidebar( array(
 'name' => 'Post Top Widget Area',
 'id' => 'custom-widget-area-post-top',
 'before_widget' => '<div id="custom-widget">',
 'after_widget' => '</div>',
 'before_title' => '<h3>',
 'after_title' => '</h3>'
) );
...
/** 
* Custom widget area added bottom post ad
*/

register_sidebar( array(
 'name' => 'Post Bottom Widget Area',
 'id' => 'custom-widget-area-post-bottom',
 'before_widget' => '<div id="custom-widget">',
 'after_widget' => '</div>',
 'before_title' => '<h3>',
 'after_title' => '</h3>'
...
register_sidebar( array(
 'name' => 'Post Bottom Widget Area',
 'id' => 'custom-widget-area-post-bottom-2',
 'before_widget' => '<div id="custom-widget">',
 'after_widget' => '</div>',
 'before_title' => '<h3>',
 'after_title' => '</h3>'
