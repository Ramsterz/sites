...
DROP TABLE IF EXISTS `wp_inbound_events`;
...
--
-- Dumping data for table `wp_inbound_events`
--

LOCK TABLES `wp_inbound_events` WRITE;
/*!40000 ALTER TABLE `wp_inbound_events` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_inbound_events` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-03-14 17:36:46
