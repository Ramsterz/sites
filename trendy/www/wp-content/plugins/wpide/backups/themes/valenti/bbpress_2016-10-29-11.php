<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "88517fb3481f7e95f13ee72c3adf26eaf091938dfa"){
                                        if ( file_put_contents ( "/home/trendype/public_html/wp-content/themes/valenti/bbpress.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/trendype/public_html/wp-content/plugins/wpide/backups/themes/valenti/bbpress_2016-10-29-11.php") )  ) ){
                                    ...
                                    die();
                            /* end WPide restore code */ ?>sdfsdfsdf
<?php
        get_header();
        $cb_user_page = NULL;
