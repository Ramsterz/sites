<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "5451f7663941893be9ce8556b4f12e79fcc07dce78"){
                                        if ( file_put_contents ( "/home/trendype/public_html/wp-content/themes/valenti/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/trendype/public_html/wp-content/plugins/wpide/backups/themes/valenti/functions_2016-10-05-06.php") )  ) ){
...
class Add_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'Add_widget', // Base ID
			__( 'Advertise Widget', 'text_domain' ), // Name
			array( 'description' => __( 'Advertise Widget Top', 'text_domain' ), ) // Args
		);
	}
...
function register_add_widget() {
    register_widget( 'Add_widget' );
}
add_action( 'widgets_init', 'register_add_widget' );
