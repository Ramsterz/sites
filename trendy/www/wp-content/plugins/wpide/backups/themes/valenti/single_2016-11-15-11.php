<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "88517fb3481f7e95f13ee72c3adf26ea5822e75b07"){
                                        if ( file_put_contents ( "/home/trendype/public_html/wp-content/themes/valenti/single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/trendype/public_html/wp-content/plugins/wpide/backups/themes/valenti/single_2016-11-15-11.php") )  ) ){
...
<?php echo do_shortcode('[widget id="text-26"]'); ?>
                            ...
                            <!-- /115083185/TP_LB1 -->
                            <div id='div-gpt-ad-1479203852312-0' style='height:90px; width:728px;'>
                            <script>
                            ...
                            <!-- /115083185/TP_M_LB -->
                            <div id='div-gpt-ad-1479203852312-3' style='height:50px; width:320px;display:none;'>
                            <script>
