...
function ti_wp_link_pages( $args ){
	...
	// Keep next for the main part
    $args['next_or_number'] = 'next';
		$args['after'] = '<br style="clear:both;" />';
		$args['nextpagelink'] = 'NEXT <span class="arrow">></span>';
		$args['previouspagelink'] = '<span class="arrow"><</span> PREV';
		$args['separator'] = '<div class="seperator">&nbsp;</div>';
