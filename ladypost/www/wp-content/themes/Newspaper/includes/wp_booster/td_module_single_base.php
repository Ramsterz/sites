...
class td_module_single_base extends td_module {
    ...
    function get_post_pagination() {
        ...
        return wp_link_pages(array(
            'next_or_number'=>'next',
            'before' => '<div class="page-nav page-nav-post td-pb-padding-side footer-custom-pages">',
            'after' => '</div>',
            'link_before' => '<div class="td-div-link-paging">',
            'link_after' => '</div>',
            'echo' => false,
            'nextpagelink'     => 'NEXT<i class="td-icon-menu-right"></i>',
            'previouspagelink' => '<i class="td-icon-menu-left"></i>BACK'
        ));
    }
